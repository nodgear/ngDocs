...
export default class CategoryProject {
	...
	constructor() {
		...
		this.add_tag(new Tag("see", 2, false, false, true));
		this.add_tag(new AliasTag("constructor", 0, ["@category globals"]));
		this.add_tag(new Tag("field", 3, false));
		this.add_tag(new Tag("internal", 1, false, false, true));
		this.add_tag(new Tag("warn", 1, false, false, true));
		this.add_tag(
		...
		this.add_category(new Category("Modules"), true, "module");
		...
		this.add_category_type("Modules");
